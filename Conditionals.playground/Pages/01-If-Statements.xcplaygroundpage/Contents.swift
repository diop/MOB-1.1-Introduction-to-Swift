...
let lessThan = 2000 < 1
let greaterThan = 1 > 1000
let equalTo = 1000 == 1001
let equalToString = "thisString" == "thatString"
let notEqualTo = "boolean" != "another boolean"
let lessThanEqualTo = 10 <= 1100
let greaterThanEqualTo = 1 >= 0
